...
Query:
---------------
Select id,name,ivybase__Location_Hierarchy__r.Name,ivybase__Resource_Type__r.Name,ivybase__flag__c from ivybase__HHTModule_Master__c where name = 'VGP_SOS_REASON_MANDATE' AND ivybase__Resource_Type__r.Name= 'MY Dist Mer Storefix' And ivybase__flag__c=1</description>
   <name>AISS-REGR_VGP_SOS_TC0076_MANDATE</name>
   <tag></tag>
   <elementGuidId>88b71da6-3a2a-4074-8dee-2ee016bb5876</elementGuidId>

...
<WebServiceRequestEntity>
   ...
   <name>Promo_Decimal</name>
   <tag></tag>
   <elementGuidId>3bbb0e41-3546-42a3-8ac7-663823aafa16</elementGuidId>
   ...
   <restUrl>${instance_url}/services/data/v53.0/query/?q=SELECT Category__c,Instruction__c,Market_Measure_Master__r.Type__c, Market_Measure_Master__r.Screen_Group__c FROM Measure_Mapping__c WHERE Market_Measure_Master__r.Screen_Group__c = 'PROMOTION' AND Market_Measure_Master__r.Type__c = 'Decimal' AND Store_Hierarchy__c = 'a0g2H000007FzBqQAK'</restUrl>
